...
import { IdEntryForm } from "@/components/ui/id-entry-form"
...
export default function SignIn({languageType}) {
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button className="bg-blue-600 hover:bg-blue-700"
                onClick={() => redirect(`/signup?language=${language}`)}
              >
              {t.nav.signup} </Button>
              <Button
                variant="ghost"
...
<section className="w-full pt-24 pb-12 md:pt-32 md:pb-24 lg:pt-40 lg:pb-32 relative overflow-hidden">
        ...
        <IdEntryForm languageType={language}/>
